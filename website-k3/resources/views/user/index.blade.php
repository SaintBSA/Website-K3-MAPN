                ...
                <table class="table table-striped align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30%;" class="text-end">Aksi Manajemen</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        $badgeClass = ($user->role == 'admin') ? 'danger' : (($user->role == 'spv') ? 'primary' :
                        'secondary');
                        @endphp
                        <tr>
                            <td>{{ $user->name }}</td>
                                ...
                                <div style="display: flex; gap: 5px; justify-content: flex-end; align-items: center;">
                                    ...
                                    <form method="POST" action="{{ route('user.update.role', $user->id) }}"
                                        ...
                                        <select name="role" class="form-select form-select-sm" style="width: 140px;"
                                            required>
                                            <option value="unassigned" {{ is_null($user->role) ? 'selected' : '' }}>
                                                Unassigned</option>
