...
<body>
    ...
    <div class="main-content">
        ...
        @endif
        @if ($errors->any())
        <div class="alert alert-danger">Gagal menambahkan opsi baru. Pastikan nama tidak duplikat dalam kategori yang
            sama.</div>
        @endif
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ route('master.update', $item->id) }}"
                                    style="display:inline;">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" name="toggle_status" value="1">
                                    <button type="submit"
                                        class="btn btn-sm btn-{{ $item->is_active ? 'outline-danger' : 'outline-success' }}">
