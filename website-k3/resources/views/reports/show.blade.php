...
<body>
    ...
    <div class="sidebar d-flex flex-column">
        ...
        <nav class="nav flex-column px-3">
            ...
            @php $isReportActive = in_array(Route::currentRouteName(), ['reports.index', 'reports.show',
            'reports.edit']); @endphp
        ...
        <div class="card card-detail p-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <p class="data-value">
                        {{ $report->incident_datetime ? \Carbon\Carbon::parse($report->incident_datetime)->format('d M Y, H:i') : 'N/A' }}
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    @php
                    $statusColor = ['Pending' => 'warning', 'In Progress' => 'info', 'Closed' => 'success', 'Overdue' =>
                    'danger', 'Not Applicable' => 'secondary'];
