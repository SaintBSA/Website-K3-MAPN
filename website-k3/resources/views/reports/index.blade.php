            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>
                                ...
                                @endphp
                                <a href="{{ route('reports.index', array_merge(request()->query(), ['sort' => $nextSort])) }}"
                                    class="text-decoration-none ms-1">
                                    <i
                                        class="bi bi-sort-down {{ $sort == 'latest' ? 'text-primary' : 'text-muted' }}"></i>
                                </a>
                            </th>
                            <th>Lokasi</th>
                            <th>Jenis Insiden</th>
                    ...
                    <tbody>
                        ...
                        @php
                        $statusColor = ['Pending' => 'warning', 'In Progress' => 'info', 'Closed' => 'success',
                        'Overdue' => 'danger', 'Not Applicable' => 'secondary'];
                        ...
                        @endphp
                        <tr>
                            <td><span class="fw-semibold">K3-{{ str_pad($report->id, 4, '0', STR_PAD_LEFT) }}</span>
                            </td>
                            ...
                            <td><span class="badge text-bg-{{ $currentPriorityColor }}">{{ $report->priority }}</span>
                            </td>
                            <td>
